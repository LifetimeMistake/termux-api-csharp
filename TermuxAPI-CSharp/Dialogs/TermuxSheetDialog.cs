...
{
    public class TermuxSheetDialog : TermuxDialog
    {
        ...
        {
            return JsonConvert.DeserializeObject<DialogSheetResponse>(response);
        }

        public TermuxSheetDialog(string[] values, string title = null)
        {
            Title = title;
            Values = values;
        }
